...
//        Log.d(TAG, "L A T I T U D E: " + String.valueOf(location.getLatitude()));
//        LocationProvider location = new LocationProvider(MainActivity.this);
...
//        final double longitude = location.getLongitude();
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = getString(R.string.forecastKey);
